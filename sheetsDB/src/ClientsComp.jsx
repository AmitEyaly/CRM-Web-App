        ...
        <div>
            ...
            <div className="row align-self-center" style={{ height: "100vh" }}>
                <div className="col-lg-10 col-sm-12 p-0">
                    ...
                    {selectedView === "Pricing" && <PricingComp />}
                    {selectedView === "EventDet" && <EventDetComp />}
                        ...
                        <ul className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <li className="nav-item row mt-3 p-1">
                                <button className="btn btn-outline-info"
                                    onClick={() => setSelectedView("Pricing")}>הזמנה חדשה</button>
                            </li>
                            <li className="nav-item row mt-3 p-1 ">
                                <button
                                    className="btn btn-outline-info"
                                    onClick={() => setSelectedView("EventDet")} >ההזמנות שלי</button>
                            </li>
                            <li className="nav-item row mt-3 p-1 ">
                                <button className="btn btn btn-outline-info"
                                    onClick={() => setSelectedView("avalebility")}>בדיקת זמינות</button>
                            </li>
                        </ul>
                    </div>
                </div>
