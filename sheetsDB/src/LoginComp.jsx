    ...
    <div className="container">
      ...
      <form action="" className="">
        <div className="row" style={{ justifyContent: "center" }}>
          <div className="col-7">
            <input type="text" placeholder="שם מלא" style={{ textAlign: "right" }} className="form-control " />
            <br />
          </div>
          <div className="col-7">
            <input type="text" placeholder="סיסמא" style={{ textAlign: "right" }} className="form-control" />
            <br />
          </div>
          <div className="col-7">
            <button type="text"
              ...
              className="btn btn-success" >כניסה</button>
          </div>
        </div>
      </form>
      <br />
      <br />
      <button><Link to="/register">הרשמה למערכת</Link></button>
    </div>
  )
}
